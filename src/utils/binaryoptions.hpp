...
#ifndef UTILS_BINARYOPTIONS_HPP
#define UTILS_BINARYOPTIONS_HPP
...
//
// void argUsage() { fprintf(stderr, "[arg1 [arg2 [arg3 ...]]]\n\n"); }
// void argDetails() { fprintf(stderr, "DESCRIPTION\n\n Lengthy tome.\n\n"); }
// void helpExample() { fprintf(stderr, "EXAMPLE\n\n foo -option1 file1\n"); }
//
...
public:
  ...
  void usage(const char *progname, const std::function<void()> &argUsage) const;
...
private:
  ...
  void helpOptionDetails(const BinaryOption *option) const;
